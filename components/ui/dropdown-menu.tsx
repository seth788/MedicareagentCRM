...
const DropdownMenuCheckboxItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.CheckboxItem> & { hideIndicator?: boolean }
>(({ className, children, checked, hideIndicator = true, ...props }, ref) => (
...
const DropdownMenuRadioItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.RadioItem> & { hideIndicator?: boolean }
